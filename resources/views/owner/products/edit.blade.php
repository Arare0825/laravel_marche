    ...
    <div class="py-12">
      ...
      <div class="p-2 w-1/2 mx-auto">
        ...
        <div class="p-2 w-1/2 mx-auto">
          <div class="relative">
            ...
            <span class="text-sm">0～1000の範囲で入力してください</span>
          </div>
        </div>
      ...
      <div class="p-2 w-1/2 mx-auto">
        ...
        <div class="p-2 w-1/2 mx-auto">
          ...
          @csrf
          @method('delete')  
          <define_syslog_variables class="md:px-4 py-3">
          <div class="p-2 w-full flex justify-around mt-32">
            <a href="#" data-id="{{ $product->id }}"  button onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded ">削除する</a>
            </div>
        </div>
         </form>
