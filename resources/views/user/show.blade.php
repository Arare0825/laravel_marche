<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4 text-center">
                <button data-micromodal-trigger="modal-1" href="javascript:;" type="button" class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-400 rounded">ショップの詳細を見る</button>
            </div>
        </div>
    </div>
</div>
</div>
<div class="z-40 modal micromodal-slide" id="modal-1" aria-hidden="true">
